...
workspace/create/                       & POST   & Enables an authenticated user to create a new workspace. When a user creates a workspace he is the manager of that workspace. & U  \\ \hline
