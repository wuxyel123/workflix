...
function loadTemplate() {
  var headerUrl = new URL(
    contextPath + "/src/main/webapp/html/Reusable-snippets/header.html"
  );
  var sidebarUrl = new URL(
    contextPath + "/src/main/webapp/html/Reusable-snippets/sidebar.html"
  );
  var footerUrl = new URL(
    contextPath + "/src/main/webapp/html/Reusable-snippets/footer.html"
  );
